...
func (in *FenceAgentsRemediationTemplateSpec) DeepCopyInto(out *FenceAgentsRemediationTemplateSpec) {
	*out = *in
	if in.StatusValidationSample != nil {
		in, out := &in.StatusValidationSample, &out.StatusValidationSample
...
func (in *FenceAgentsRemediationTemplateStatus) DeepCopyInto(out *FenceAgentsRemediationTemplateStatus) {
	*out = *in
	...
	if in.ValidationFailed != nil {
		in, out := &in.ValidationFailed, &out.ValidationFailed
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ValidationPassed != nil {
		in, out := &in.ValidationPassed, &out.ValidationPassed
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretParams) DeepCopyInto(out *SecretParams) {
	*out = *in
	if in.params != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretParams.
func (in *SecretParams) DeepCopy() *SecretParams {
	if in == nil {
		return nil
	}
	out := new(SecretParams)
	in.DeepCopyInto(out)
	return out
}
