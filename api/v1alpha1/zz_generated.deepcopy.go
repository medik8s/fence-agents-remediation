...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParameterValidationResult) DeepCopyInto(out *ParameterValidationResult) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParameterValidationResult.
func (in *ParameterValidationResult) DeepCopy() *ParameterValidationResult {
	if in == nil {
		return nil
	}
	out := new(ParameterValidationResult)
	in.DeepCopyInto(out)
	return out
}
